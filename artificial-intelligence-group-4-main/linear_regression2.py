...
# Get delay info from chatbot
delay_info = json.loads(sys.argv[1])[0]

print(predict_arrival_time_lr(delay_info["depStation"], delay_info["arrStation"],
    delay_info["delay"], delay_info["pta"]))
